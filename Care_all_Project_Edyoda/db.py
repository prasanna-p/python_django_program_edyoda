...
mycursor.execute("CREATE TABLE IF NOT EXISTS users (PK_user_id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(25), email VARCHAR(25) UNIQUE, password VARCHAR(255), mobile VARCHAR(10) UNIQUE)")
